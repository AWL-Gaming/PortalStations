### 1.4.7
- Fixed bundled ServerSync broadcast crash on Valheim 1.0 after ZRoutedRpc.Everybody became a const

### 1.4.6
- Updated for current Valheim Hoverable API compatibility
- Fixed portable build references for current Valheim development environments
